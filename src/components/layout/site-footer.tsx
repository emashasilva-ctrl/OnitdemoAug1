    ...
    <footer className="border-t border-border bg-secondary/40">
      <div className="mx-auto max-w-6xl px-4 py-12 sm:px-6">
        <div className="grid grid-cols-2 gap-8 sm:grid-cols-4">
          ...
          <div>
            <h3 className="text-sm font-semibold text-foreground">Dining</h3>
            <ul className="mt-4 space-y-3">
              <li>
              ...
              <li>
                <Link href="/dining/restaurants" className="text-sm text-muted-foreground hover:text-foreground">
                  Browse Restaurants
                </Link>
              </li>
              <li>
                <Link href="/dining/partner" className="text-sm text-muted-foreground hover:text-foreground">
        ...
        <div className="mt-10 flex flex-col gap-2 border-t border-border pt-6 text-sm text-muted-foreground sm:flex-row sm:items-center sm:justify-between">
          ...
          <p>No booking fees on Beauty &middot; Card on file for Dining</p>
        </div>
      </div>
    </footer>
  );
